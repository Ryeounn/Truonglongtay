...
const ArticleList = () => {
    ...
    const deleteArticles = (stdid) => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                axios.post('http://localhost:8080/admin/deleteari', {
                    id: stdid,
                }).then(response => {
                    Swal.fire({
                        icon: 'success',
    ...
    const loadArticles = async () => {
        const result = await axios.post("http://localhost:8080/admin/getall");
...
const CreateArticle = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios
            .post("http://localhost:8080/admin/create", article)
            .then((response) => {
...
const EditArticle = () => {
    ...
    const loadArticles = async () => {
        const result = await axios.get(`http://localhost:8080/admin/articles/${id}`);
    ...
    const onSubmit = async e => {
        e.preventDefault();
        await axios.put('http://localhost:8080/admin/articles/${id}', article);
        navigate("/");
    };
    const updateArticle = async e => {
        e.preventDefault();
        await axios.post("http://localhost:8080/admin/articles");
        navigate('/');
