...
const FeedbackList = () => {
  ...
  useEffect(() => {
    axios.post("http://localhost:8080/student/getfeedback")
      .then(res => {
  ...
  const deleteFeedback = (feedbackID) => {
    fetch(`http://localhost:8080/student/delete/${feedbackID}`, {
      method: 'DELETE',
    })
      .then((response) => {
        if (response.ok) {
...
const CreateFeedback = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post('http://localhost:8080/student/create', feedback)
      .then((response) => {
...
const UpdateFeedback = () => {
  ...
  useEffect(() => {
    axios.post('http://localhost:8080/student/find', { feedbackId: feedbackid })
      .then((response) => {
